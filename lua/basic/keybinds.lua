...
vim.keymap.set({ "i", "n", "v" }, "<F5>", "<cmd>lua require('dap').continue()<CR>", { desc = "continue"})
vim.keymap.set({ "i", "n", "v" }, "<F9>", "<cmd>lua require('dap').toggle_breakpoint()<CR>", { desc = "toggle breakpoint" })
vim.keymap.set({ "i", "n", "v" }, "<F10>", "<cmd>lua require('dap').step_into()<CR>", { desc = "step into" })
vim.keymap.set({ "i", "n", "v" }, "<F11>", "<cmd>lua require('dap').step_over()<CR>", { desc = "step over" })
vim.keymap.set({ "i", "n", "v" }, "<F12>", "<cmd>lua require('dap').step_out()<CR>", { desc = "step out" })
vim.keymap.set({ "i", "n", "v" }, "<F8>", "<cmd>lua require('dap').terminate()<CR>", { desc = "terminate" })
...
------------------------------------- snacks -----------------------------------
-- zen
vim.keymap.set({"n"}, "<leader>sz", "<cmd>lua require('snacks').zen()<cr>", { desc = "Zen"})
...
vim.keymap.set({"n"}, "<leader>sn", "<cmd>lua require('snacks').picker.notifications()<cr>", { desc = "Notification History" })
...
-- find
vim.keymap.set({"n"}, "<leader>se", "<cmd>lua require('snacks').explorer()<cr>", { desc = "Explorer" })
...
vim.keymap.set({"n"}, "<leader>gd", "<cmd>lua require('snacks').picker.git_diff()<cr>", { desc = "Git Diff" })

-- Grep
vim.keymap.set({"n"}, "<leader>sb", "<cmd>lua require('snacks').picker.lines()<cr>", { desc = "Buffer Lines" })
vim.keymap.set({"n"}, "<leader>sB", "<cmd>lua require('snacks').picker.grep_buffers()<cr>", { desc = "Grep Open Buffers" })
vim.keymap.set({"n"}, "<leader>sg", "<cmd>lua require('snacks').picker.grep()<cr>", { desc = "Grep" })
vim.keymap.set({"n", "x"}, "<leader>sw", "<cmd>lua require('snacks').picker.grep_word()<cr>", { desc = "Visual selection or word" })
...
vim.keymap.set({"n"}, "<leader>sp", "<cmd>lua require('snacks').picker.projects()<cr>", { desc = "Projects" })
...
-- 将当前行的改动提交到暂存区，即add
vim.keymap.set({ 'n', 'v' }, '<leader>gs', require('gitsigns').stage_hunk, { desc = "Git Stage Hunk" })
-- 撤销提交暂存区，即undo
...
--  显示当前文件的修改列表
vim.keymap.set('n', '<leader>gl', require('gitsigns').setqflist, { desc = "Git File List" })
--  显示当前项目的所有修改列表
