...
vim.keymap.set({ "i", "n", "v" }, "<F12>", function()
	require("dap").step_out()
end, { desc = "DAP: step out" })
vim.keymap.set({ "i", "n", "v" }, "<F9>", function()
	require("dap").toggle_breakpoint()
end, { desc = "DAP: toggle breakpoint" })
-- vim.keymap.set('n', '<Leader>db', function() require('dap').set_breakpoint() end, { desc = "set breakpoint" })
vim.keymap.set({ "i", "n", "v" }, "<F10>", function()
	require("dap").step_into()
end, { desc = "DAP: step into" })
vim.keymap.set({ "i", "n", "v" }, "<F11>", function()
...
vim.keymap.set(
	"n",
	"<leader>s/",
	"<cmd>lua require('snacks').picker.search_history()<cr>",
	{ desc = "Searched History" }
)
...
vim.keymap.set(
	"n",
	"<leader>un",
	"<cmd>lua require('snacks').notifier.hide()<cr>",
...
vim.keymap.set(
	"n",
	"<leader>sS",
	"<cmd>lua require('snacks').picker.lsp_workspace_symbols()<cr>",
...
vim.keymap.set(
	...
	{ desc = "Lazygit: Current File Git History" }
)
...
vim.keymap.set(
	"n",
	"<leader>fc",
	"<cmd>lua require('snacks').picker.files({ cwd = vim.fn.stdpath('config') }) <cr>",
...
vim.keymap.set(
	"n",
	"<leader>fB",
	"<cmd>lua require('snacks').picker.buffers({ hidden = true, nofile = true, })<cr>",
	{ desc = "Buffers(all)" }
)
-- 搜索项目目录
...
vim.keymap.set(
	"n",
	"<leader>sD",
	"<cmd>lua require('snacks').picker.diagnostics_buffer()<cr>",
	{ desc = "Buffer Diagnostics" }
)

-- Grep Word
vim.keymap.set("n", "<leader>sg", "<cmd>lua require('snacks').picker.grep()<cr>", { desc = "Grep Current Dir" })
vim.keymap.set("n", "<leader>sw", "<cmd>lua require('snacks').picker.grep_word()<cr>",
...
vim.keymap.set(
	"n",
	"<leader>sc",
	"<cmd>lua require('snacks').picker.command_history()<cr>",
...
-- 修正错误code action
vim.keymap.set("n", "ga", vim.lsp.buf.code_action, { desc = "Code Action [LSP]" })
...
end, { desc = "List Folders [Workspace]" })

-- 工作区搜索
vim.keymap.set("n", "<leader>ws", function()
	vim.lsp.buf.workspace_symbol(vim.fn.input("Symbols: "))
end, { desc = "Workspace Search [Workspace]" })
